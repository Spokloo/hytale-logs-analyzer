...
This is a fork of https://github.com/tintin10q/minecraft-logs-analyzer.
Since Hytale logs works in the same way as Minecraft logs, I thought this was the best way to provide a way of seeing your playtime as there are no other ways currently.
Feel free to modify things if you see some ways to improve it.
